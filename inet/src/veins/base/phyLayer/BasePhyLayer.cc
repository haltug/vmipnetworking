...
inet::Coord NoMobiltyPos = inet::Coord::ZERO;
...
void BasePhyLayer::filterSignal(AirFrame *frame) {
	...
	const inet::Coord sendersPos  = sendersMobility  ? sendersMobility->getCurrentPosition(/*sStart*/) : NoMobiltyPos;
	const inet::Coord receiverPos = receiverMobility ? receiverMobility->getCurrentPosition(/*sStart*/): NoMobiltyPos;
