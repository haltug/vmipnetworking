//#include "veins/modules/mac/ieee80211p/Wave1609_4_RSU.h"
//
...
//#define DBG_MAC EV
//
//Define_Module(Wave1609_4_RSU);
//
//void Wave1609_4_RSU::initialize(int stage)
//{
...
//}
//
//void Wave1609_4_RSU::handleSelfMsg(cMessage *msg)
//{
...
//}
//
//void Wave1609_4_RSU::handleUpperControl(cMessage* msg) {
//    cRuntimeError("Wave1609_4_RSU should not receive any upper control message. Not defined.");
//}
//
//void Wave1609_4_RSU::handleUpperMsg(cMessage* msg) {
//
////    inet::IPv6Datagram *ctrl = check_and_cast<inet::Ieee802Ctrl *>(msg->removeControlInfo());
...
//    t_channel chan;
//
//    //rewrite SCH channel to actual SCH the Wave1609_4_RSU is set to
...
//}
//
//void Wave1609_4_RSU::handleLowerControl(cMessage* msg) {
...
//        cRuntimeError("Wave1609_4_RSU received control message from lower layer that has unknown type.");
//    }
//
...
//}
//
//void Wave1609_4_RSU::setActiveChannel(t_channel state) {
//    activeChannel = state;
//    assert(state == type_CCH || (useSCH && state == type_SCH));
//}
//
//void Wave1609_4_RSU::finish() {
//    //clean up queues.
//
...
//}
//
//void Wave1609_4_RSU::attachSignal(Mac80211Pkt* mac, simtime_t startTime, double frequency, uint64_t datarate, double txPower_mW) {
//
...
//}
//
//Signal* Wave1609_4_RSU::createSignal(simtime_t start, simtime_t length, double power, uint64_t bitrate, double frequency) {
...
//bool Wave1609_4_RSU::guardActive() const {
...
//simtime_t Wave1609_4_RSU::timeLeftTillGuardOver() const {
//    ASSERT(useSCH);
...
//simtime_t Wave1609_4_RSU::timeLeftInSlot() const {
//    ASSERT(useSCH);
...
//void Wave1609_4_RSU::changeServiceChannel(int cN) {
//    ASSERT(useSCH);
...
//}
//
//void Wave1609_4_RSU::setTxPower(double txPower_mW) {
//    txPower = txPower_mW;
//}
//void Wave1609_4_RSU::setMCS(enum PHY_MCS mcs) {
//    ASSERT2(mcs != MCS_DEFAULT, "invalid MCS selected");
//    bitrate = getOfdmDatarate(mcs, BW_OFDM_10_MHZ);
//    setParametersForBitrate(bitrate);
//}
//
//void Wave1609_4_RSU::setCCAThreshold(double ccaThreshold_dBm) {
//    phy11p->setCCAThreshold(ccaThreshold_dBm);
//}
//
//void Wave1609_4_RSU::handleLowerMsg(cMessage* msg) {
...
//    // TODO replace Mac80211Pkt with Ieee802frame
//    ctrl->setSrc(inet::MACAddress(macPkt->getAddress3()));
//    ctrl->setDest(inet::MACAddress(macPkt->getDestAddr()));
...
//}
//
//int Wave1609_4_RSU::EDCA::queuePacket(t_access_category ac,inet::IPv6Datagram* msg) {
//
...
//}
//
//int Wave1609_4_RSU::EDCA::createQueue(int aifsn, int cwMin, int cwMax,t_access_category ac) {
//
...
//}
//
//Wave1609_4_RSU::t_access_category Wave1609_4_RSU::mapPriority(int prio) {
...
//}
//
//inet::IPv6Datagram* Wave1609_4_RSU::EDCA::initiateTransmit(simtime_t lastIdle) {
//
...
//}
//
//simtime_t Wave1609_4_RSU::EDCA::startContent(simtime_t idleSince,bool guardActive) {
//
...
//}
//
//void Wave1609_4_RSU::EDCA::stopContent(bool allowBackoff, bool generateTxOp) {
//    //update all Queues
//
...
//    }
//}
//void Wave1609_4_RSU::EDCA::backoff(t_access_category ac) {
...
//}
//
//void Wave1609_4_RSU::EDCA::postTransmit(t_access_category ac) {
...
//}
//
//void Wave1609_4_RSU::EDCA::cleanUp() {
//    for (std::map<t_access_category, EDCAQueue>::iterator iter = myQueues.begin(); iter != myQueues.end(); iter++) {
...
//}
//
//void Wave1609_4_RSU::EDCA::revokeTxOPs() {
//    for (std::map<t_access_category, EDCAQueue>::iterator iter = myQueues.begin(); iter != myQueues.end(); iter++) {
...
//}
//
//void Wave1609_4_RSU::channelBusySelf(bool generateTxOp) {
//
...
//}
//
//void Wave1609_4_RSU::channelBusy() {
//
//    if (!idleChannel) return;
//
...
//}
//
//void Wave1609_4_RSU::channelIdle(bool afterSwitch) {
//
...
//}
//
//void Wave1609_4_RSU::setParametersForBitrate(uint64_t bitrate) {
...
//
//
//simtime_t Wave1609_4_RSU::getFrameDuration(int payloadLengthBits, enum PHY_MCS mcs) const {
//    simtime_t duration;
//    if (mcs == MCS_DEFAULT) {
