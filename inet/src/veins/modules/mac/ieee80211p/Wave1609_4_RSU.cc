...
void Wave1609_4_RSU::attachSignal(inet::ieee80211::Ieee80211DataOrMgmtFrame* mac, simtime_t startTime, double frequency, uint64_t datarate, double txPower_mW) {
...
int Wave1609_4_RSU::EDCA::queuePacket(t_access_category ac,inet::ieee80211::Ieee80211DataOrMgmtFrame* msg) {
...
inet::ieee80211::Ieee80211DataOrMgmtFrame* Wave1609_4_RSU::EDCA::initiateTransmit(simtime_t lastIdle) {
