...
class INET_API BaseMobility : public cSimpleModule, public cListener
//: public BatteryAccess
{
  public:
    /**
  ...
  public:
    ...
    virtual inet::Coord getCurrentPosition(/*simtime_t_cref stWhen = simTime()*/) const {
  ...
  protected:
    ...
    virtual void makeMove(){
    	cRuntimeError("BaseMobility does not move the host");
    };
    ...
    virtual void fixIfHostGetsOutside(){
    	cRuntimeError("fixIfHostGetsOutside has to be redefined by the user");
    };
